...
public class Getmore {
  ...
  static List<SysUsers> getmo(WebDriver driver) {
    ...
    List<WebElement> elements1 = driver.findElements(By.cssSelector("body > div.search_container > div.wrapper > div:nth-ch" +
            "ild(1) > div.result_item.result_item_v > div._playl" +
            "ist > div > div > div > div:nth-child(13) > a"));
    System.out.println(elements1.get(0).getText());
    if(elements1.get(0).getText().equals("..."))
